...
VALUES ('Latte', (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic'),
    '250 ml', 150, 'Espresso, milk'),
    ('Latte Grande', (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic'),
    '400 ml', 210, 'Espresso, milk'),
    ('Cappuccino', (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic'),
    '250 ml', 150, 'Espresso, milk'),
    ('Cappuccino Grande', (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic'),
    '400 ml', 210, 'Espresso, milk'),
    ('Raf', (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic'),
    '250 ml', 180, 'Espresso, milk, cream, vanilla sugar'),
    ('Raf Grande', (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic'),
    '400 ml', 250, 'Espresso, milk, cream, vanilla sugar');
--rollback DELETE FROM products WHERE product_category = (SELECT id FROM products_categories WHERE category_name = 'Coffee Classic');

--changeset steshabolk:2
INSERT INTO products (product_name, product_category, size_value, price, description)
VALUES ('Raff "Salted caramel"', (SELECT id FROM products_categories WHERE category_name = 'Coffee Specialty'),
...
INSERT INTO products (product_name, product_category, size_value, price, description)
VALUES ('Caramel Syrup', (SELECT id FROM products_categories WHERE category_name = 'Syrup'),
...
INSERT INTO products (product_name, product_category, size_value, price, description)
VALUES ('Chocolate Chips', (SELECT id FROM products_categories WHERE category_name = 'Topping'),
        '10 g', 30, 'Chocolate chips'),
       ('Whipped Cream', (SELECT id FROM products_categories WHERE category_name = 'Topping'),
        '10 g', 30, 'Whipped cream'),
       ('Marshmallows', (SELECT id FROM products_categories WHERE category_name = 'Topping'),
        '10 g', 30, 'Marshmallows');
--rollback DELETE FROM products WHERE product_category = (SELECT id FROM products_categories WHERE category_name = 'Topping');
...
VALUES ('Lactose-free Milk', (SELECT id FROM products_categories WHERE category_name = 'Milk'),
       ...
       ('Soy Milk', (SELECT id FROM products_categories WHERE category_name = 'Milk'),
        '100 ml', 70, 'Soy milk'),
       ('Banana Milk', (SELECT id FROM products_categories WHERE category_name = 'Milk'),
        '100 ml', 70, 'Banana milk');
--rollback DELETE FROM products WHERE product_category = (SELECT id FROM products_categories WHERE category_name = 'Milk');

--changeset steshabolk:6
INSERT INTO products (product_name, product_category, size_value, price, description)
VALUES ('Pancakes', (SELECT id FROM products_categories WHERE category_name = 'Food'),
        '190 g', 300, 'Pancakes with custard, caramel and almond petals'),
       ('Chicken and mushroom pie', (SELECT id FROM products_categories WHERE category_name = 'Food'),
        '150 g', 100, 'Pastry pie stuffed with chicken fillet, champignons and cream sauce'),
       ('Turkey and tomato sandwich', (SELECT id FROM products_categories WHERE category_name = 'Food'),
        '190 g', 200, 'Snack of ciabatta with turkey, tomatoes and cream cheese'),
       ('Ham and cheese sandwich', (SELECT id FROM products_categories WHERE category_name = 'Food'),
        '170 g', 200, 'Sandwich bun with ham, cheese, lettuce leaf and mayonnaise sauce with mustard'),
       ('Croissant with salmon and cream cheese', (SELECT id FROM products_categories WHERE category_name = 'Food'),
       ...
       ('Avocado toast', (SELECT id FROM products_categories WHERE category_name = 'Food'),
        '240 g', 320, 'Classic toast with avocado and cottage cheese');
--rollback DELETE FROM products WHERE product_category = (SELECT id FROM products_categories WHERE category_name = 'Food');

--changeset steshabolk:7
INSERT INTO products (product_name, product_category, size_value, price, description)
VALUES ('Croissant', (SELECT id FROM products_categories WHERE category_name = 'Pastries'),
        '65 g', 75, 'Classic French croissant made of puff pastry with natural butter'),
       ('Almond croissant', (SELECT id FROM products_categories WHERE category_name = 'Pastries'),
        '100 g', 125, 'Fragrant croissant with almond cream, covered with peanut petals'),
       ('Cinnamon roll', (SELECT id FROM products_categories WHERE category_name = 'Pastries'),
        '150 g', 85, 'Tender, fluffy and gooey cinnamon rolls with vanilla silky cream cheese icing on top'),
       ('Walnut poppy seed roll', (SELECT id FROM products_categories WHERE category_name = 'Pastries'),
        '95 g', 70, 'Sweet bun stuffed with poppy seeds and walnuts, glazed with sugar syrup'),
       ('Puff with cheese and spinach', (SELECT id FROM products_categories WHERE category_name = 'Pastries'),
        '160 g', 95, 'Puff pastry with soft pickled cheese and spinach'),
       ('Puff with cranberries, cloudberries and mascarpone', (SELECT id FROM products_categories WHERE category_name = 'Pastries'),
        '145 g', 135, 'Crispy pastry with an air cream based on mascarpone cheese, tart cloudberry sauce and sour-sweet cranberries');
--rollback DELETE FROM products WHERE product_category = (SELECT id FROM products_categories WHERE category_name = 'Pastries');

--changeset steshabolk:8
INSERT INTO products (product_name, product_category, size_value, price, description)
VALUES ('Classic cheesecake', (SELECT id FROM products_categories WHERE category_name = 'Desserts'), '120 g', 170,
        'The delicate sand base is made with natural butter, and the air cream is made of cream cheese and natural cream'),
       ('Coconut chocolate cheesecake', (SELECT id FROM products_categories WHERE category_name = 'Desserts'), '125 g', 180,
        'Cheesecake with a coconut base and classic chocolate-covered cream cheese mousse'),
       ('Brownie', (SELECT id FROM products_categories WHERE category_name = 'Desserts'), '120 g', 140,
        'Classic American chocolate brownie with peanuts and walnuts'),
       ('Berry tart', (SELECT id FROM products_categories WHERE category_name = 'Desserts'), '130 g', 155,
        'Dessert based on caramel shortcrust pastry, delicate almond cream and juicy raspberries, blueberries and cherries'),
       ('Mango eclair', (SELECT id FROM products_categories WHERE category_name = 'Desserts'), '70 g', 95,
        'Delicate and airy eclair with mango cream, covered with white chocolate fondant'),
       ('Salted caramel eclair', (SELECT id FROM products_categories WHERE category_name = 'Desserts'), '70 g', 95,
...
--rollback DELETE FROM products WHERE product_category = (SELECT id FROM products_categories WHERE category_name = 'Desserts');
