...
VALUES (16, (SELECT id FROM products WHERE product_name = 'Coconut chocolate cheesecake'), 1, 180),
       (16, (SELECT id FROM products WHERE product_name = 'Salted caramel eclair'), 2, 190),
       (16, (SELECT id FROM products WHERE product_name = 'Turkey and tomato sandwich'), 1, 200),
       (16, (SELECT id FROM products WHERE product_name = 'Chicken and mushroom pie'), 1, 100);
...
INSERT INTO orders_details (order_id, product_id, quantity, cost)
VALUES (17, (SELECT id FROM products WHERE product_name = 'Latte Grande'), 1, 240),
       (17, (SELECT id FROM products WHERE product_name = 'Latte Grande'), 1, 210),
       (17, (SELECT id FROM products WHERE product_name = 'Pancakes'), 1, 300),
       (17, (SELECT id FROM products WHERE product_name = 'Avocado toast'), 1, 320);
...
VALUES (43, (SELECT id FROM products WHERE product_name = 'Chocolate Chips'));
--rollback DELETE FROM orders_details_additives WHERE order_details_id = 25;
